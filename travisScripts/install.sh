...
curl --retry 5 -o Unity_win.pkg http://download.unity3d.com/download_unity/bfcbae508940/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2017.3.0p3.pkg
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
