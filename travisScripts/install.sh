...
curl --retry 5 -o Unity.pkg http://download.unity3d.com/download_unity/edf5bdf50eb0/MacEditorInstaller/Unity.pkg
...
curl --retry 5 -o Unity_win.pkg http://download.unity3d.com/download_unity/edf5bdf50eb0/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2017.2.1p1.pkg
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
